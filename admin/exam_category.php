                                                        ...
                                                        while ($row = mysqli_fetch_array($res)) 
                                                        {
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="edit_exam_category.php?id=<?php echo $row["id_exam"] ?>" class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
